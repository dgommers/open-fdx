...
Example of Signature's current API format in [JSON](/examples/signature/signature-supporter.json) based on the supporters endpoint of their [API](https://signatureapp.de/api/docs).
